...
class Train(ModelSaver):
    ...
    def training(self, data_path, output_path, use_gpu=False, rnn_type='gru', mode=2, epochs=10, batch_size=50, sequence_length=10, train_test_ratio=0.1, label_term=10,
