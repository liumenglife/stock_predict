    ...
    def __init__(self, mode, rnn_type, num_layers, sequence_length, use_bidirectional, dim_hidden, num_labels):
        ...
        with tf.variable_scope('dynamic_rnn') as scope:
            ...
            for i in range(num_layers):
                ...
                cell = cell_type[rnn_type](num_units=dim_hidden, activation=tf.tanh)
            ...
            if self.use_bidirectional:
                ...
                for i in range(num_layers):
                    ...
                    cell_bi = cell_type[rnn_type](num_units=dim_hidden, activation=tf.tanh)
        ...
        with tf.variable_scope('logits') as scope:
            self.logits = self._logits(mode, outputs)

        with tf.name_scope('loss'):
            self.loss = self._loss(mode, self.logits)
